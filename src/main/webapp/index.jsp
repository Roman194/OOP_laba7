...
<head>
    ...
    <!-- Bootstrap prising component was partly used here -->
    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                <h1 class="display-4 fw-normal text-body-emphasis">Fast & secure</h1>
                <p class="fs-5 text-body-secondary">Protect your network privacy with one of the best VPN services. You can choose more than 300 services all over the world!</p>
            </div>
        </header>
    </div>
    <main>
                ...
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>10 services included</li>
                            <li>valid for 2 hours</li>
                            <li>common services support</li>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>150 services included</li>
                            <li>valid for 10 hours</li>
                            <li>Priority common services support</li>
                            <li>Help center access</li>
                        </ul>
            ...
            <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                    ...
                    <div class="card-body">
                        ...
                        <ul class="list-unstyled mt-3 mb-4">
                            <li>300 services included</li>
                            <li>valid for 15 hours</li>
                            <li>High-speed services support</li>
                            <li>Help center access</li>
                        </ul>
        ...
        <div class="table-responsive">
            <table class="table text-center">
                ...
                <tbody>
                <tr>
                    <th scope="row" class="text-start">Public services</th>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                </tr>
                <tr>
                    <th scope="row" class="text-start">Private services</th>
                    <td></td>
                    <td></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                </tr>
                ...
                <tbody>
                <tr>
                    <th scope="row" class="text-start">No adds</th>
                    <td></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                </tr>
                <tr>
                    <th scope="row" class="text-start">Sharing on other device</th>
                    <td></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                </tr>
                <tr>
                    <th scope="row" class="text-start">Personal help center manager</th>
                    <td></td>
                    <td></td>
                    <td><svg class="bi" width="24" height="24"><use xlink:href="#check"/></svg></td>
                </tr>

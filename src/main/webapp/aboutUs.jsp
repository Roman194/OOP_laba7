...
<div class="container py-3">
    <header>
        ...
        <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
            ...
            <p class="fs-5 text-body-secondary">Our company was founded in times when convenient desktop apps for better interact with OS was something from other reality. Our mission for 7 years is to make it possible!</p>
        </div>
    </header>
    <main>
        <h2 class="display-6 text-center mb-4">Our team</h2>
        <div class="team_photo">
            <img class="mb-2" src="${pageContext.request.contextPath}/assets/our_team.jpg" alt="" width="700" height="468">
        </div>
        <h4 class="display-8 text-center mb-6">By Roman Zyuzin / SEN-222/2</h4>
    </main>

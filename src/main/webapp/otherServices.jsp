    ...
    <div class="container py-3">
        <header>
            ...
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
                ...
                <p class="fs-5 text-body-secondary">Our company has several apps that can suit your needs! They all have free versions and 1-month trial period of pro versions</p>
            </div>
        </header>
        <main>
            <h2 class="display-6 text-center mb-4">Check our apps!</h2>
            <div class="table-responsive">
                <table class="table text-center">
                    <tbody>
                    <tr>
                        <th scope="row" class="text-start">Bruh Secure</th>
                        <td class="text-body-secondary">Makes your PC safer with downloads check</td>
                        <td class="mb-1"><a class="link-secondary text-decoration-none" href="#">More info...</a></td>
                    </tr>
                    <tr>
                        <th scope="row" class="text-start">Bruh Cleaner</th>
                        <td class="text-body-secondary">Delete unuseful files from your PC</td>
                        <td class="mb-1"><a class="link-secondary text-decoration-none" href="#">More info...</a></td>
                    </tr>
                    </tbody>
                    ...
                    <tbody>
                    <tr>
                        <th scope="row" class="text-start">Bruh Updater</th>
                        <td class="text-body-secondary">Notificate you when new version of your apps is out</td>
                        <td class="mb-1"><a class="link-secondary text-decoration-none" href="#">More info...</a></td>
                    </tr>
                    <tr>
                        <th scope="row" class="text-start">Bruh Uninstaller</th>
                        <td class="text-body-secondary">Helps you to completely delete some of your apps</td>
                        <td class="mb-1"><a class="link-secondary text-decoration-none" href="#">More info...</a></td>
                    </tr>
                    </tbody>
                </table>
